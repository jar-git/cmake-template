...
#ifndef JAR_NET2_SHUTDOWN_MODE_HPP
#define JAR_NET2_SHUTDOWN_MODE_HPP
...
[[nodiscard]] inline auto to_integral(shutdown_mode mode) noexcept
{
...
[[nodiscard]] inline auto to_literal(shutdown_mode mode) noexcept
{
  switch (mode) {
...
#endif  // JAR_NET2_SHUTDOWN_MODE_HPP
