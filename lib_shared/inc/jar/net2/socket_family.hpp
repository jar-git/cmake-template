...
#ifndef JAR_NET2_SOCKET_DOMAIN_HPP
#define JAR_NET2_SOCKET_DOMAIN_HPP
...
[[nodiscard]] inline auto to_integral(socket_family family) noexcept
{
...
[[nodiscard]] inline auto to_literal(socket_family family) noexcept
{
  switch (family) {
...
#endif  // JAR_NET2_SOCKET_DOMAIN_HPP
