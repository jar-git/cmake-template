...
#ifndef JAR_NET_SOCKET_TYPE_HPP
#define JAR_NET_SOCKET_TYPE_HPP
...
inline auto to_integral(socket_type mode) noexcept { return static_cast<std::underlying_type_t<socket_type>>(mode); }
...
inline auto to_literal(socket_type type) noexcept
{
  switch (type) {
