...
if(gold)
    ...
    elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
	    ...
	    set(CMAKE_STATIC_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -fuse-ld=lld")
	    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -fuse-ld=lld")
	    # set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -flto -use-gold-plugin")
        # set(CMAKE_STATIC_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -flto -use-gold-plugin -plugin /usr/lib/llvm-6.0/lib/LLVMgold.so")
        # set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -flto -use-gold-plugin -plugin /usr/lib/llvm-6.0/lib/LLVMgold.so")
    elseif(MSVC)
        # Microsoft Compiler.
    endif()
endif()
